...
class Test_Inference(unittest.TestCase):
    ...
    def test_process_path(self):
        ...
        ***please-> put a path of one photo.jepeg as the example below  
        ...
        path = os.path.abspath(os.path.join(currentDir, "../../system_files/tf_flower_images/image_daisy_45.jpeg"))
    ...
    def test_parse_function(self):
        ...
        ***please-> put a path of one .tfrecords as the example below
        """
        filename = os.path.abspath(os.path.join(currentDir, "../../system_files/tf_flower_tf_records/part-001-db.tfrecord"))
    ...
    def test_tfrecords_to_write_embeddings(self):
        ...
        for i in range(0,10):
            ...
            path = os.path.abspath(os.path.join(currentDir, "../../system_files/tf_flower_tf_records/part-00%s-db.tfrecord" %i))
