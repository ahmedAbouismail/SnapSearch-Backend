...
{
    // this class was imported from https://github.com/kphillpotts/IcelandMoss/blob/master/src/IcelandMoss/IcelandMoss/Storyboard.cs
    // the code was written by Kym Phillpotts and has an MIT License.
    // the class as a whole is used to manage states of objects so they can be animated
    // by switching to another state
    // todo - add comments to the methods to better understand this class
